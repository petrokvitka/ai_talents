...
const modelUrl = "tfjs_fpn_v1/model.json";

const threshold = 0.3;
const imageSize = 512;
const labelsMapUrl = "tfjs_fpn_v1/labels-map.json";
...
async function runModel() {
  if (imageElement) {
    ...
    const output = await model.executeAsync(img, ["detection_scores", "detection_boxes", "detection_classes", "num_detections"]);
